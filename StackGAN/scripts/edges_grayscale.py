"""
Script that builds the edges->grayscale dataset used
by our edges2grayscale conditional GAN. It takes in raw
...
def build_samples(count=0):
    """
    Function that builds and saves samples.
    count - Number of samples to convert. If 0, convert entire dataset.
    """
    ...
    for file in celeba:
        ...
        plt.imsave(
            output_edges_directory + str(built) + ".jpg",
            np.asarray(edges_resampled),
            cmap="gray",
        )
        plt.imsave(
