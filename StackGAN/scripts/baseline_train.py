"""
Our current implementation of the baseline GAN that generates edges from 
...
def weights_init(m):
    ...
    m - Set of weights to initialize
    """
...
for epoch in range(num_epochs):
    ...
    for i, data in enumerate(dataloader, 0):
        ...
        for _ in range(5):
            ...
            # Get fake images
            fake = netG(torch.randn(batch_size, nz, 1, 1, device=device)).to(device)
        ...
        print(
            ...
            % (epoch + 1, num_epochs, i, len(dataloader), D_loss, G_loss)
        )
